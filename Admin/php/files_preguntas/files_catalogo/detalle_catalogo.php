...
$query=$Detalle->Conn->prepare("select * from pregunta p inner join det_cat_pregunta dp on (p.idpregunta=dp.idpregunta) where dp.idcatalogo_p=:id order by p.idpregunta");
